const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/settings-DMsN4uC4.js","assets/toast-BelPYyVA.js","assets/settings-T_GEU958.css","assets/dashboard-D3pFzOXW.js","assets/Tree-BO7Gl1HM.js","assets/Tree-CvCJSwdn.css","assets/uid-CgJ15W9t.js","assets/dashboard-DipLYKIr.css","assets/articleEditor-DgP3gd_y.js","assets/richTextEditor-DPtOcj4q.js","assets/richTextEditor-8I7AIxnE.css","assets/articleEditor-IvAiT0Lb.css","assets/manuscripts-Dus874Rx.js","assets/manuscripts-Dr0Jvelc.css"])))=>i.map(i=>d[i]);
    ...
    StateManagedSelect$1,
    {
      ...
      styles: {
        ...
        option: (baseStyles, state) => ({
          ...baseStyles,
          backgroundColor: state.isSelected ? "var(--accent)" : state.isFocused ? "var(--accent)" : "var(--menu-color)",
...
const LS_PROJECT_NAME = "CurrentProject";
...
function fetchReferenceables(project, type) {
  if (type) {
...
function ChangeProjectPopup({ style }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "change-project-popup", style, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-window", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "popup-header", children: "Select project" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      WLSelect,
      {
        className: "change-project-select",
        options: projectList.map((t, i) => ({ value: t, label: t })),
        onChange: (e) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "button", className: "create-new-project", id: "create-new-project", value: "Create new", onClick: () => {
      window.location = "/createProject";
    } })
  ] }) });
}
function Navbar() {
  var [navbarCollapsed, setNavbarCollapsed] = reactExports.useState(true);
  const [projectSelectPopupVisible, setProjectSelectPopupVisible] = reactExports.useState(false);
  document.documentElement.style.setProperty("--navbar-pages", 4);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "Navbar", collapsed: navbarCollapsed ? "." : void 0, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "NavbarButtons", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            window.location = "/dashboard";
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-table-columns fa-lg" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tooltip", children: "Dashboard" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            window.location = "/maps";
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-map fa-lg" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tooltip", children: "Maps" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            window.location = "/manuscripts";
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-book fa-lg" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tooltip", children: "Manuscripts" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            window.location = "/timelines";
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-timeline fa-lg" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tooltip", children: "Timelines" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            window.location = "/namegen";
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-signature fa-lg" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tooltip", children: "Name Generator" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            window.location = "/settings";
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa-solid fa-gear fa-lg" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tooltip", children: "Settings" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
            setProjectSelectPopupVisible(!projectSelectPopupVisible);
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { class: "fa-solid fa-arrows-spin fa-lg" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tooltip", children: "Change Project" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "collapse-switch", onClick: () => setNavbarCollapsed((prev2) => !prev2) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ChangeProjectPopup, { style: {
...
function ThemeProvider({ children }) {
  const [Theme, SetThemeRaw] = reactExports.useState(localStorage.getItem("Theme") ?? (window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"));
...
const referencePopupContext = reactExports.createContext();
function ReferencePopupProvider({ children }) {
  const [isOpen, setIsOpen] = reactExports.useState(false);
  const [currentType, setCurrentType] = reactExports.useState(null);
  const selectObj = reactExports.useRef();
  const getReferenceRef = reactExports.useRef();
  ...
  function acceptReference(e) {
    if (getReferenceRef.current) {
      getReferenceRef.current(JSON.stringify({
        ...
        text: options2[selectObj.current.selectedIndex].text
      }));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(referencePopupContext.Provider, { value: openPopup, children: [
    children,
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reference-inline-popup", style: { display: isOpen ? "block" : "none" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "inline-reference-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx("select", { name: "reference", id: "inline-reference", style: { width: "100%" }, ref: selectObj, children: options2.map(
        (opt) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: opt.uid, children: opt.text })
      ) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: acceptReference, children: "Accept" })
    ] })
  ] });
}
const useReferencePopup = () => reactExports.useContext(referencePopupContext);
const SettingsPage = reactExports.lazy(() => __vitePreload(() => import("./settings-DMsN4uC4.js"), true ? __vite__mapDeps([0,1,2]) : void 0));
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./dashboard-D3pFzOXW.js"), true ? __vite__mapDeps([3,4,5,6,7]) : void 0));
const ArticleEditorPage = reactExports.lazy(() => __vitePreload(() => import("./articleEditor-DgP3gd_y.js"), true ? __vite__mapDeps([8,9,6,10,1,11]) : void 0));
const ManuscriptsPage = reactExports.lazy(() => __vitePreload(() => import("./manuscripts-Dus874Rx.js"), true ? __vite__mapDeps([12,9,6,10,4,5,1,13]) : void 0));
function App() {
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ReferencePopupProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ThemeProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(BrowserRouter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading..." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/settings", Component: SettingsPage }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/dashboard", Component: DashboardPage }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/article", Component: ArticleEditorPage }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/manuscripts", Component: ManuscriptsPage })
      ] })
    ] })
  ] }) }) });
}
