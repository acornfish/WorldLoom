import { c as createCommonjsModule, r as react, p as process } from '../common/index-31dd246a.js';
...
function updateEvent(callback) {
  ...
  return function () {
    if (0 !== (executionContext & 2)) throw Error(formatProdErrorMessage$1(440));
    ...
    if (didSuspend)
      if (workInProgress.flags & 256)
        ...
        (workInProgress.child = current.child),
          ...
          (workInProgress = null);
      else throw Error(formatProdErrorMessage$1(558));
    else if (
      (didReceiveUpdate ||
  ...
  switch (workInProgress.tag) {
    ...
    case 31:
      ...
      if (null === current || null !== current.memoizedState) {
        ...
        if (null !== renderLanes) {
          if (null === current) {
            if (!newProps) throw Error(formatProdErrorMessage$1(318));
            current = workInProgress.memoizedState;
            current = null !== current ? current.dehydrated : null;
            if (!current) throw Error(formatProdErrorMessage$1(557));
            current[internalInstanceKey] = workInProgress;
          } else
            resetHydrationState(),
              0 === (workInProgress.flags & 128) &&
        ...
        if (0 !== (workInProgress.flags & 128))
          throw Error(formatProdErrorMessage$1(558));
      }
      bubbleProperties(workInProgress);
      return null;
    case 13:
